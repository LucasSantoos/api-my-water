...
CREATE SEQUENCE SEQ_ENDERECOS_ID;
...
CREATE TABLE ENDERECOS (
	ID INTEGER NOT NULL DEFAULT NEXTVAL('SEQ_ENDERECOS_ID'),
	ID_CIDADE INTEGER NOT NULL,
	DESCRICAO VARCHAR(255) NOT NULL,
	NUMERO VARCHAR (5),
	BAIRRO VARCHAR(50),
	CONSTRAINT PK_ENDERECOS PRIMARY KEY (ID),
	CONSTRAINT FK_CIDADES_ESTADOS FOREIGN KEY (ID_CIDADE) REFERENCES CIDADES(ID)
);
...
ALTER SEQUENCE SEQ_ENDERECOS_ID
